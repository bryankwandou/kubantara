    ...
    <main className="min-h-screen bg-slate-950 px-6 py-16 text-slate-200">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-6 space-y-4 leading-relaxed text-slate-300">
          ...
          <p>2. Tidak ada pembelian dengan uang sungguhan, tidak ada iklan, dan tidak ada obrolan dengan orang asing. Di dalam permainan ada toko pakaian yang hanya bisa dibayar dengan keping hasil bermain di gua. Kepemilikan pakaian dicatat di Solana devnet, jaringan uji yang koinnya tidak bernilai uang dan tidak bisa ditukar dengan uang. Orang tua dapat memeriksanya di halaman Bukti kepemilikan.</p>
